...
public class TrashFab extends AppCompatImageView {
    ...
    private static final int DEFAULT_RADIUS_OPEN = ViewUtil.dp2px(160);
    private static final int DEFAULT_RADIUS_APPEAR = ViewUtil.dp2px(48);

    private PointF trashCenter;

    public int marginBottom;

    private int visibleMarginBottom;
    private int radiusAppear;
    ...
    public TrashFab(Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
        ...
        marginBottom = toolbarBottomHeight + visibleMarginBottom;
        Timber.d("marginBottom: %dpx", marginBottom);
        radiusAppear = array.getDimensionPixelSize(R.styleable.TrashFab_radiusAppear,
                DEFAULT_RADIUS_APPEAR);
        Timber.d("radiusAppear: %dpx", radiusAppear);
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        ((ViewGroup.MarginLayoutParams) getLayoutParams()).bottomMargin = marginBottom;
